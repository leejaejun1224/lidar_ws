// Generated by gencpp from file local_pkg/NavPVTWithHeader.msg
// DO NOT EDIT!


#ifndef LOCAL_PKG_MESSAGE_NAVPVTWITHHEADER_H
#define LOCAL_PKG_MESSAGE_NAVPVTWITHHEADER_H
...
struct NavPVTWithHeader_
{
  typedef NavPVTWithHeader_<ContainerAllocator> Type;
  ...
  NavPVTWithHeader_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , iTOW(0)
    , year(0)
    , month(0)
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> const> ConstPtr;

}; // struct NavPVTWithHeader_

typedef ::local_pkg::NavPVTWithHeader_<std::allocator<void> > NavPVTWithHeader;

typedef boost::shared_ptr< ::local_pkg::NavPVTWithHeader > NavPVTWithHeaderPtr;
typedef boost::shared_ptr< ::local_pkg::NavPVTWithHeader const> NavPVTWithHeaderConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::local_pkg::NavPVTWithHeader_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::local_pkg::NavPVTWithHeader_<ContainerAllocator1> & lhs, const ::local_pkg::NavPVTWithHeader_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
{
  ...
  static const char* value(const ::local_pkg::NavPVTWithHeader_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x76a709426465468aULL;
  static const uint64_t static_value2 = 0x80d5b09ed58df78dULL;
};

template<class ContainerAllocator>
struct DataType< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::local_pkg::NavPVTWithHeader_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::local_pkg::NavPVTWithHeader_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // LOCAL_PKG_MESSAGE_NAVPVTWITHHEADER_H
