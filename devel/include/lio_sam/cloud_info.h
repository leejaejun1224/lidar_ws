...
struct cloud_info_
{
  ...
  _cloud_surface_type cloud_surface;
   ...
   typedef  ::sensor_msgs::PointCloud2_<ContainerAllocator>  _cone_inner_type;
  _cone_inner_type cone_inner;

   typedef  ::sensor_msgs::PointCloud2_<ContainerAllocator>  _cone_outer_type;
  _cone_outer_type cone_outer;

   typedef  ::sensor_msgs::PointCloud2_<ContainerAllocator>  _left_cone_type;
  _left_cone_type left_cone;

   typedef  ::sensor_msgs::PointCloud2_<ContainerAllocator>  _right_cone_type;
  _right_cone_type right_cone;
...
bool operator==(const ::lio_sam::cloud_info_<ContainerAllocator1> & lhs, const ::lio_sam::cloud_info_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.cone_inner == rhs.cone_inner &&
    lhs.cone_outer == rhs.cone_outer &&
    lhs.left_cone == rhs.left_cone &&
    lhs.right_cone == rhs.right_cone;
}
...
struct MD5Sum< ::lio_sam::cloud_info_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x7eeb8b423d5a30adULL;
  static const uint64_t static_value2 = 0x7be7c5f84fbec6c1ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lio_sam::cloud_info_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.cone_inner);
      stream.next(m.cone_outer);
      stream.next(m.left_cone);
      stream.next(m.right_cone);
    }
...
struct Printer< ::lio_sam::cloud_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lio_sam::cloud_info_<ContainerAllocator>& v)
  {
    ...
    s << indent << "cone_inner: ";
    s << std::endl;
    Printer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::stream(s, indent + "  ", v.cone_inner);
    s << indent << "cone_outer: ";
    s << std::endl;
    Printer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::stream(s, indent + "  ", v.cone_outer);
    s << indent << "left_cone: ";
    s << std::endl;
    Printer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::stream(s, indent + "  ", v.left_cone);
    s << indent << "right_cone: ";
    s << std::endl;
    Printer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::stream(s, indent + "  ", v.right_cone);
  }
};
