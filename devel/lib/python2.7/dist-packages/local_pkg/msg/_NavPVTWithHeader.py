...
"""autogenerated by genpy from local_pkg/NavPVTWithHeader.msg. Do not edit."""
import codecs
import sys
...
class NavPVTWithHeader(genpy.Message):
  _md5sum = "76a709426465468a80d5b09ed58df78d"
  _type = "local_pkg/NavPVTWithHeader"
...
"""
  ...
  __slots__ = ['header','iTOW','year','month','day','hour','min','sec','valid','tAcc','nano','fixType','flags','flags2','numSV','lon','lat','height','hMSL','hAcc','vAcc','velN','velE','velD','gSpeed','heading','sAcc','headAcc','pDOP','reserved1','headVeh','magDec','magAcc']
  _slot_types = ['std_msgs/Header','uint32','uint16','uint8','uint8','uint8','uint8','uint8','uint8','uint32','int32','uint8','uint8','uint8','uint8','int32','int32','int32','int32','uint32','uint32','int32','int32','int32','int32','int32','uint32','uint32','uint16','uint8[6]','int32','int16','uint16']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,iTOW,year,month,day,hour,min,sec,valid,tAcc,nano,fixType,flags,flags2,numSV,lon,lat,height,hMSL,hAcc,vAcc,velN,velE,velD,gSpeed,heading,sAcc,headAcc,pDOP,reserved1,headVeh,magDec,magAcc
    ...
    """
    if args or kwds:
      super(NavPVTWithHeader, self).__init__(*args, **kwds)
