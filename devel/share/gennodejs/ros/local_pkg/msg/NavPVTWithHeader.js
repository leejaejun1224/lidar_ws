...
class NavPVTWithHeader {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavPVTWithHeader(null);
  ...
  static datatype() {
    ...
    return 'local_pkg/NavPVTWithHeader';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '76a709426465468a80d5b09ed58df78d';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavPVTWithHeader(null);
...
module.exports = NavPVTWithHeader;
