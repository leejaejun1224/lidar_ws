...
(cl:defmethod cl:initialize-instance :after ((m <Serial_Info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Serial_Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name local_pkg-msg:<Serial_Info> is deprecated: use local_pkg-msg:Serial_Info instead.")))

(cl:ensure-generic-function 'auto_manual-val :lambda-list '(m))
(cl:defmethod auto_manual-val ((m <Serial_Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader local_pkg-msg:auto_manual-val is deprecated.  Use local_pkg-msg:auto_manual instead.")
  (auto_manual m))

(cl:ensure-generic-function 'emergency_stop-val :lambda-list '(m))
(cl:defmethod emergency_stop-val ((m <Serial_Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader local_pkg-msg:emergency_stop-val is deprecated.  Use local_pkg-msg:emergency_stop instead.")
  (emergency_stop m))
...
(cl:defmethod steer-val ((m <Serial_Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader local_pkg-msg:steer-val is deprecated.  Use local_pkg-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <Serial_Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader local_pkg-msg:brake-val is deprecated.  Use local_pkg-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'encoder-val :lambda-list '(m))
(cl:defmethod encoder-val ((m <Serial_Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader local_pkg-msg:encoder-val is deprecated.  Use local_pkg-msg:encoder instead.")
  (encoder m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Serial_Info>)))
  ...
  (cl:format cl:nil "int16 auto_manual~%int16 emergency_stop~%int16 gear~%float32 speed~%float32 steer~%int32 brake~%float64[] encoder~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Serial_Info)))
  "Returns full string definition for message of type 'Serial_Info"
  (cl:format cl:nil "int16 auto_manual~%int16 emergency_stop~%int16 gear~%float32 speed~%float32 steer~%int32 brake~%float64[] encoder~%~%~%"))
