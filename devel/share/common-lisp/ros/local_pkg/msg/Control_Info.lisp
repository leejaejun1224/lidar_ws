...
(cl:defmethod cl:initialize-instance :after ((m <Control_Info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control_Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name local_pkg-msg:<Control_Info> is deprecated: use local_pkg-msg:Control_Info instead.")))
