...
(cl:ensure-generic-function 'cone_inner-val :lambda-list '(m))
(cl:defmethod cone_inner-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lio_sam-msg:cone_inner-val is deprecated.  Use lio_sam-msg:cone_inner instead.")
  (cone_inner m))

(cl:ensure-generic-function 'cone_outer-val :lambda-list '(m))
(cl:defmethod cone_outer-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lio_sam-msg:cone_outer-val is deprecated.  Use lio_sam-msg:cone_outer instead.")
  (cone_outer m))

(cl:ensure-generic-function 'left_cone-val :lambda-list '(m))
(cl:defmethod left_cone-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lio_sam-msg:left_cone-val is deprecated.  Use lio_sam-msg:left_cone instead.")
  (left_cone m))

(cl:ensure-generic-function 'right_cone-val :lambda-list '(m))
(cl:defmethod right_cone-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lio_sam-msg:right_cone-val is deprecated.  Use lio_sam-msg:right_cone instead.")
  (right_cone m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cloud_info>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'cone_inner) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'cone_outer) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'left_cone) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'right_cone) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cloud_info>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'cone_inner) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'cone_outer) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'left_cone) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'right_cone) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cloud_info>)))
  ...
  "7eeb8b423d5a30ad7be7c5f84fbec6c1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cloud_info)))
  "Returns md5sum for a message object of type 'cloud_info"
  "7eeb8b423d5a30ad7be7c5f84fbec6c1")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cloud_info>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'cone_inner))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'cone_outer))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'left_cone))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'right_cone))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cloud_info>))
  ...
  (cl:list 'cloud_info
    ...
    (cl:cons ':cone_inner (cone_inner msg))
    (cl:cons ':cone_outer (cone_outer msg))
    (cl:cons ':left_cone (left_cone msg))
    (cl:cons ':right_cone (right_cone msg))
))
