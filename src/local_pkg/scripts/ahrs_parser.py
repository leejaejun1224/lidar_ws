...
class AHRS_Parsing:
    ...
    def parser(self):
        ...
        try:
            ...
            self.raw_data.linear_acceleration.x = float(sdata[7]) # <g -> m/s**2>
            self.raw_data.linear_acceleration.y = float(sdata[8])
            self.raw_data.linear_acceleration.z = float(sdata[9]) # Linear Accelerometer
