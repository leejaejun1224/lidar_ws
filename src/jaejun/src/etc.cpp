...
public:
    ...
    void projectPointCloud(){
        ...
        for (size_t i = 0; i < cloudSize; ++i){
            ...
            if (sqrt(thisPoint.x * thisPoint.x + thisPoint.y * thisPoint.y) > sensorMinimumRange && sqrt(thisPoint.x * thisPoint.x + thisPoint.y * thisPoint.y) < emergencyRange && thisPoint.z > 0.0){
                emergencyCount += 1;
                // std::cout << emergencyCount << ": " << sqrt(thisPoint.x * thisPoint.x + thisPoint.y * thisPoint.y) << std::endl;
            ...
            if (thisPoint.x < 20.0 && thisPoint.x > -1.0 && thisPoint.y > -8.0 && thisPoint.y < 8.0){// && thisPoint.z > -0.6 && thisPoint.z < 2.0){
